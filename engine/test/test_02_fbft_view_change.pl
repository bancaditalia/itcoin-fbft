...
:- begin_tests(test_02_fbft_view_change).
...
test(test_view_change_15, [setup(build_config(Config))]) :-
  ...
  assertion( member([Config.req_digest_1, V, N], Active_roast_init_1) ),
  ...
  active_ROAST_INIT(1, Active_roast_init_2),
  assertion( member([Config.req_digest_1, V, N], Active_roast_init_2) ),
  ...
  active_ROAST_INIT(1, Active_roast_init_3),
  assertion( member([Config.req_digest_1, V, N], Active_roast_init_3) ).
  % active_EXECUTE(3, Active_execute_3),
  % assertion( member([Config.req_digest_1, V, N], Active_execute_3) ).


:- end_tests(test_02_fbft_view_change).
