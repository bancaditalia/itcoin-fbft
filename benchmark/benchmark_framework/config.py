...
from benchmark_framework.utils import check_int_in_range, BaseParameters, \
    ConfigError, SignatureAlgoField, Int, PositiveInt, NonnegativeInt, Float, add_zeros_prefix, ConvertToSet, check_greater_than
...
class BenchParameters(BaseParameters):
    ...
    signature_algorithm: str = SignatureAlgoField()
