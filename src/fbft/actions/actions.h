...
class ProcessNewView: public Action {
  public:
    ...
    static std::vector<std::unique_ptr<actions::ProcessNewView>> BuildActives(const itcoin::FbftConfig& config,
      blockchain::Blockchain& blockchain, wallet::RoastWallet& wallet);
...
class SendCommit : public Action {
  public:
    SendCommit(wallet::RoastWallet& wallet,
      PlTerm Replica_id, PlTerm Req_digest, PlTerm V, PlTerm N);
    ~SendCommit(){};
...
class SendPrePrepare : public Action {
  public:
    ...
    static std::vector<std::unique_ptr<actions::SendPrePrepare>> BuildActives(const itcoin::FbftConfig& config,
      blockchain::Blockchain& blockchain, wallet::RoastWallet& wallet);
...
class SendViewChange : public Action {
  public:
    ...
    static std::vector<std::unique_ptr<actions::SendViewChange>> BuildActives(const itcoin::FbftConfig& config,
      blockchain::Blockchain& blockchain, wallet::RoastWallet& wallet);
