#ifndef ITCOIN_PBFT_STATE_STATE_H
#define ITCOIN_PBFT_STATE_STATE_H
...
namespace actions = itcoin::pbft::actions;
...
// These functions are not specific to a replica, but affect all of them
...
#endif // ITCOIN_PBFT_STATE_STATE_H
