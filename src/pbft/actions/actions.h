#ifndef ITCOIN_PBFT_ACTIONS_ACTIONS_H
#define ITCOIN_PBFT_ACTIONS_ACTIONS_H
...
class Execute : public Action {
  public:
    Execute(itcoin::SIGNATURE_ALGO_TYPE sig_algo, blockchain::Blockchain& blockchain, wallet::Wallet& wallet,
    ...
    static std::vector<std::unique_ptr<actions::Execute>> BuildActives(const itcoin::PbftConfig& config,
      blockchain::Blockchain& blockchain, wallet::Wallet& wallet);

  private:
    itcoin::SIGNATURE_ALGO_TYPE m_sig_algo;
    blockchain::Blockchain& m_blockchain;
    wallet::Wallet& m_wallet;
...
class ProcessNewView: public Action {
  public:
    ...
    static std::vector<std::unique_ptr<actions::ProcessNewView>> BuildActives(const itcoin::PbftConfig& config,
      blockchain::Blockchain& blockchain, wallet::Wallet& wallet);
...
class ReceiveBlock : public Action {
  public:
    ...
    std::string identify() const;
    std::optional<std::reference_wrapper<const messages::Message>> message() const {return std::optional<std::reference_wrapper<const messages::Message>>((const messages::Message&) m_msg);}
...
class ReceiveNewView : public Action {
  public:
    ReceiveNewView(wallet::Wallet& wallet, uint32_t replica_id, messages::NewView msg);
    ~ReceiveNewView() {};
...
class RecoverView: public Action {
  public:
    ...
    static std::vector<std::unique_ptr<actions::RecoverView>> BuildActives(const itcoin::PbftConfig& config,
      blockchain::Blockchain& blockchain, wallet::Wallet& wallet);
...
class SendCommit : public Action {
  public:
    SendCommit(wallet::Wallet& wallet,
      PlTerm Replica_id, PlTerm Req_digest, PlTerm V, PlTerm N);
    ~SendCommit(){};
    ...
    static std::vector<std::unique_ptr<actions::SendCommit>> BuildActives(const itcoin::PbftConfig& config,
      blockchain::Blockchain& blockchain, wallet::Wallet& wallet);
...
class SendNewView : public Action {
  public:
    SendNewView(uint32_t replica_id,
      messages::new_view_nu_t nu,
      messages::new_view_chi_t chi
    ...
    static std::vector<std::unique_ptr<actions::SendNewView>> BuildActives(const itcoin::PbftConfig& config,
      blockchain::Blockchain& blockchain, wallet::Wallet& wallet);
...
class SendPrepare : public Action {
  public:
    ...
    static std::vector<std::unique_ptr<actions::SendPrepare>> BuildActives(const itcoin::PbftConfig& config,
      blockchain::Blockchain& blockchain, wallet::Wallet& wallet);
...
class SendPrePrepare : public Action {
  public:
    SendPrePrepare(blockchain::Blockchain& blockchain,
      PlTerm Replica_id, PlTerm Req_digest, PlTerm V, PlTerm N);
    ~SendPrePrepare(){};
    ...
    static std::vector<std::unique_ptr<actions::SendPrePrepare>> BuildActives(const itcoin::PbftConfig& config,
      blockchain::Blockchain& blockchain, wallet::Wallet& wallet);
...
class SendViewChange : public Action {
  public:
    ...
    static std::vector<std::unique_ptr<actions::SendViewChange>> BuildActives(const itcoin::PbftConfig& config,
      blockchain::Blockchain& blockchain, wallet::Wallet& wallet);
...
class RoastInit : public Action {
  ...
  public:
    ...
    static std::vector<std::unique_ptr<actions::RoastInit>> BuildActives(const itcoin::PbftConfig& config,
      blockchain::Blockchain& blockchain, wallet::Wallet& wallet);
};
...
class RoastReceiveSignatureShare : public Action {
  public:
    RoastReceiveSignatureShare(uint32_t replica_id, messages::RoastSignatureShare msg):Action(replica_id), m_msg(msg){};
...
#endif // ITCOIN_PBFT_ACTIONS_ACTIONS_H
