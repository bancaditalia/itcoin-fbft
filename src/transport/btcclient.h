...
class BtcClient {
  ...
  private:
     ...
     *     what():  Exception -32003 : Client connector error: libcurl error: 7 -> Could not connect to http://user:2KVNeKYRVrOo3xLMnr4oBkzWuNFEqcCrRHcBF1hQy9w=@127.0.0.1:38232
     *
