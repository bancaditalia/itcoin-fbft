...
vector<tuple<string, string>> STRING_2_HASH = {
    ...
    {
        string("hello🥸"),
        "38251e8670dfad8e88f3a63881e1a0c1e91170648bb26cf8300b8f5f17f79953",
    },
    {
        string("🥸hello"),
        "c6ebe1d2ad358fd30e720170d95a7216cf54c5eaf141d6d3c9f9ee049d1aadf0",
    },
};

BOOST_AUTO_TEST_SUITE(test_utils, *enabled())

BOOST_DATA_TEST_CASE(test_stringToHex,
                     bdata::make(vector<tuple<string, string>>{
                         ...
                         {
                             "utf-8 đ熃🥸",
                             "7574662d3820c491e78683f09fa5b8",
                         },
                         {
                             string("\x00", 1),
                             "00",
                         ...
                         {
                             string("\x01\x00\x01", 3),
                             "010001",
                         },
                         {
                             string("\x00\x01\x00", 3),
                             "000100",
                         },
                         {
                             string("\x01\x02\x03", 3),
                             "010203",
                         },
                     }),
                     inputString, expectedHex) {
  using itcoin::utils::stringToHex;

  BOOST_TEST(stringToHex(inputString) == expectedHex);
} // test_stringToHex

BOOST_DATA_TEST_CASE(test_string2byteVector, bdata::make(STRING_2_BYTEVECTOR), inputString,
                     expectedByteVector) {
...
BOOST_DATA_TEST_CASE(test_byteVector2string, bdata::make(STRING_2_BYTEVECTOR), expectedString,
                     inputByteVector) {
...
BOOST_DATA_TEST_CASE(test_string2byteVector_round_trip,
                     bdata::make({
                         // clang-format off
    //
...
BOOST_DATA_TEST_CASE(test_join,
...
BOOST_DATA_TEST_CASE(test_stoui_positive_base16,
...
BOOST_DATA_TEST_CASE(test_stoui_negative_base16,
...
BOOST_DATA_TEST_CASE(test_checkHex_positive,
                     bdata::make({
                         "0123456789abcdef",
                         "0123456789ABCDEF",
                         "FEDCDBA9876543210",
...
BOOST_DATA_TEST_CASE(test_checkHex_negative,
                     bdata::make({
                         "0x123456789abcdefg",
                         "123456789abcdefg",
                         "AbCdEfG",
...
BOOST_DATA_TEST_CASE(test_checkHash_positive,
                     bdata::make({
...
BOOST_DATA_TEST_CASE(test_checkHash_negative,
                     bdata::make({"g0000008819873e925422c1ff0f99f7cc9bbb232af63a077a480a3633bee1ef6",
