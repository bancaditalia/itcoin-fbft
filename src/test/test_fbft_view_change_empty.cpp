...
struct ViewChangeEmptyFixture : ReplicaStateFixture {
  ViewChangeEmptyFixture() : ReplicaStateFixture(4, 0, 60) {}
};

BOOST_AUTO_TEST_SUITE(test_fbft_view_change_empty, *utf::enabled())

BOOST_FIXTURE_TEST_CASE(test_fbft_view_change_empty_00, ViewChangeEmptyFixture) {
  try {
...
BOOST_AUTO_TEST_SUITE_END() // test_fbft_view_change_empty
